module MacOS
  class RemoteManagement
    ...
    module BitMask
      TEXT_MESSAGES     = 0b00000000000000000000000000000001 unless const_defined?(:TEXT_MESSAGES)
      CONTROL_OBSERVE   = 0b00000000000000000000000000000010 unless const_defined?(:CONTROL_OBSERVE)
      SEND_FILES        = 0b00000000000000000000000000000100 unless const_defined?(:SEND_FILES)
      DELETE_FILES      = 0b00000000000000000000000000001000 unless const_defined?(:DELETE_FILES)
      GENERATE_REPORTS  = 0b00000000000000000000000000010000 unless const_defined?(:GENERATE_REPORTS)
      OPEN_QUIT_APPS    = 0b00000000000000000000000000100000 unless const_defined?(:OPEN_QUIT_APPS)
      CHANGE_SETTINGS   = 0b00000000000000000000000001000000 unless const_defined?(:CHANGE_SETTINGS)
      RESTART_SHUT_DOWN = 0b00000000000000000000000010000000 unless const_defined?(:RESTART_SHUT_DOWN)
      OBSERVE_ONLY      = 0b00000000000000000000000100000000 unless const_defined?(:OBSERVE_ONLY)
      SHOW_OBSERVE      = 0b01000000000000000000000000000000 unless const_defined?(:SHOW_OBSERVE)
      ALL               = 0b01000000000000000000000011111111 unless const_defined?(:ALL)
      NONE              = 0b10000000000000000000000000000000 unless const_defined?(:NONE)
    end
